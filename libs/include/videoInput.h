...
public:
	...
	void setSize(int w, int h, int numBytes);
	...
	CComPtr<IKsControl> pIKsControl;
...
public:
	...
	static int listDevices(std::vector<std::pair<std::string, std::string>> vid_pid, std::vector<int>& deviceIDs, bool silent = false);
	//static int listDevices(bool silent = true);		// lyd
	...
	bool setupDevice(int deviceID, int w, int h, int mediatype);
	bool setupDevice(int deviceID, int w, int h, int mediatype, std::string vid, std::string pid);
	...
	int connectXuControl(int deviceID);
	bool set_xu(int deviceID, const uint8_t* data, int len);
	bool get_xu(int deviceID, const uint8_t req, uint8_t* data, int& len);

	int getDeviceLocationPath(std::vector<std::string>& locationPath, std::vector<std::pair<std::string, std::string>>& vid_pid);
...
private:
	...
	int  getDeviceCount();
	bool  check_deviceID_with_vid_pid(int deviceID, std::string vid, std::string pid);
